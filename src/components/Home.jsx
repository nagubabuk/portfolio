...
const Home = () => {
  const [text] = useTypewriter({
    words: ["Angular Developer", "React Developer", "Front-End Developer", "Full-Stack Developer"],
    loop: 0,
  });
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:ml-24">
          ...
          <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5, delay: 0.2 }} className="w-full md:w-1/2">
            <img src={personalData?.HomePageDeveloperIllustration} alt="Developer Illustration" className="w-full h-auto max-w-[400px] mx-auto mix-blend-lighten" />
          </motion.div>
        </div>
      </div>
    </Element>
